...
/// @nodoc
mixin _$Time {
  int get msec => throw _privateConstructorUsedError;
...
abstract class $TimeCopyWith<$Res> {
  ...
  @useResult
  $Res call({int msec, bool isRunning});
}
...
class _$TimeCopyWithImpl<$Res, $Val extends Time>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      msec: null == msec
          ? _value.msec
          : msec // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$TimeImpl implements _Time {
  const _$TimeImpl({required this.msec, required this.isRunning});
  ...
  @override
  String toString() {
    return 'Time(msec: $msec, isRunning: $isRunning)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$TimeImpl &&
            (identical(other.msec, msec) || other.msec == msec) &&
            (identical(other.isRunning, isRunning) ||
                other.isRunning == isRunning));
  }

  @override
  int get hashCode => Object.hash(runtimeType, msec, isRunning);
...
abstract class _Time implements Time {
  const factory _Time(
      {required final int msec, required final bool isRunning}) = _$TimeImpl;
